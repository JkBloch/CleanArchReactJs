...
function StateSearch({ handleChange, filters, loadStates,
    loading,
    setLoading,
    keyword,
    searchcode,
    ...
    async function handleSearch(e) {
        setLoading(true);
        await loadStates(1, sortBy, descending);
        setLoading(false);
    }
    async function handleExcelExport(e) {
        ...
        await downloadExcel(revfilters, "StateReport");
        setLoading(false);
    }
    async function handlePdfExport(e) {
        ...
        await downloadPdf(revfilters, "StateReport");
        setLoading(false);
    }
    if (loading)
        return <Loader />;

...
function DepartmentSearch({ handleChange, filters, loadDepartments,
    loading,
    setLoading,
    keyword,
    searchcode,
    ...
    async function handleSearch(e) {
        setLoading(true);
        await loadDepartments(1, sortBy, descending);
        setLoading(false);
    }
    async function handleExcelExport(e) {
        ...
        await downloadExcel(revfilters, "DepartmentReport");
        setLoading(false);
    }
    async function handlePdfExport(e) {
        ...
        await downloadPdf(revfilters, "DepartmentReport");
        setLoading(false);
    }
    if (loading)
        return <Loader />;
